...
namespace netmanager {
    ...
    public:
        ...
        // For the list of available set options and valid parameter types consult
        // curl_easy_setopt manual
        template<typename T>
        ...
        bool set(CURLoption option,
                 const QUrl &parameter);  // Convenience override for const char* parameters
        ...
        // For the list of available get options and valid parameter types consult
        // curl_easy_getinfo manual
        template<typename T>
        ...
        // that no callbacks will be called between deleteLater and curl handle
        // removal.
    ...
    protected:
        ...
        static int staticCurlXferInfoFunction(void *easyPtr,

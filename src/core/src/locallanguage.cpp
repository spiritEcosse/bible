...
namespace core {
    ...
    QHash<QString, QString> languagesNames{{"av", "Avaric"},
                                           {"an", "Aragonese"},
                                           {"arn", "Mapuche"},
                                           {"ae", "Avestan"},
                                           {"ch", "Chamorro"},
                                           ...
                                           {"pap", "Papiamento"},
                                           {"fon", "Fon"}};
    QHash<QString, QString> nativeLanguagesNames{{"ach", "Lwo"},
                                                 {"ady", "Адыгабзэ"},
                                                 {"ae", "Avesta"},
                                                 {"alt", "Алтай тили"},
                                                 {"am", ""},  // ኣማርኛ
    ...
    LocalLanguage::LocalLanguage() : QLocale() {}

    LocalLanguage::LocalLanguage(const QString &language) : QLocale(language), m_language{std::move(language)} {}
    ...
    QString LocalLanguage::languageInString() const {
        return languagesNames.value(m_language,
                                    language() == QLocale::C ? m_language : QLocale::languageToString(language()));
    }

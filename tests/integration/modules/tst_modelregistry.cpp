...
{
    QJsonArray array;
    array << QJsonObject {{"url", "link1"}, {"priority", 1}, {"info_url", "link1"}};
    array << QJsonObject {{"url", "link2"}, {"priority", 2}, {"info_url", "link2"}};
    array << QJsonObject {{"url", "link3"}, {"priority", 3}, {"info_url", "link3"}};

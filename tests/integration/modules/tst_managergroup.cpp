...
namespace modules {
    namespace tests {
        ...
        QJsonDocument tst_ManagerGroup::helperGetInvalidDocument() const {
            ...
            return QJsonDocument{QJsonObject{{"downloads", array}}};
        }
        ...
        void tst_ManagerGroup::makeCollections_data() {
            ...
            QTest::newRow("not valid data")
                << helperGetInvalidDocument() << std::vector<Module>{} << std::vector<GroupModulesShared>{} << false;
        }
        ...
        void tst_ManagerGroup::makeCollections() {
            ...
            if(hit) {
                ...
                std::for_each(dereference_iterator(groupModules.begin()),
                              ...
                              [&managerGroup](const auto &groupModules) {
                                  const MGKey mgKey{groupModules.nameToStdString(),
